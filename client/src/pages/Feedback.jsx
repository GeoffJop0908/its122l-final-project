  ...
  return (
    <>
      <div className="h-screen flex flex-col items-center justify-start">
        ...
        {/* Main Content Pane */}
        <div className="h-screen bg-gray-200 w-full flex flex-col items-center py-20">
          ...
          <div className="max-w-6xl w-full flex flex-row justify-between">
            ...
            <div className="w-5/12">
              <h1 className="text-5xl font-bold text-black mb-8">Send us a Feedback</h1>
            ...
            <div className="w-5/12 justify-center">
              <fieldset className="fieldset mt-2">
                <legend className="fieldset-legend text-lg">Username / Email:</legend>
              ...
              <div className="flex justify-center w-full pt-5">
                <button className="bg-black text-white py-3 px-10 rounded text-lg">Submit</button>
              </div>
            </div>
