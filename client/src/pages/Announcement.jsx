    ...
    <>
      <div className="h-screen flex flex-col items-center justify-start">
        ...
        <div className=" h-screen bg-gray-200 w-full flex flex-col items-center py-15">
          ...
          <ul className="list bg-base-100 rounded-box shadow-md max-w-[70%] w-full max-h-[50%] overflow-y-auto">
            <li className="list-row">
              <div><img className="size-10 rounded-box" src={icon}/></div>
              <div>
                <div>Knee Gears for sale</div>
                <div className="text-xs uppercase font-semibold opacity-60">July 2, 1839</div>
              </div>
            ...
            <li className="list-row">
              ...
              <div>
                <div>Sample</div>
                <div className="text-xs uppercase font-semibold opacity-60">January 1, 2000</div>
              </div>
              <p className="list-col-wrap text-sm">
            ...
            <li className="list-row">
              ...
              <div>
                ...
                <div className="text-xs uppercase font-semibold opacity-60">March 17, 2025</div>
              </div>
              <p className="list-col-wrap text-sm">
