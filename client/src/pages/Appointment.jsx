  ...
  return (
    <>
      <div className="h-screen flex flex-col items-center justify-start">
        ...
        <div className="w-full h-28 bg-[#222222]"></div>

        {/* Main Content Pane */}
        <div className="h-screen bg-gray-200 w-full flex flex-col items-center py-15">
          <div className="w-full max-w-4xl mx-auto px-8">
            <h1 className="text-5xl font-bold text-black pb-10">Book an Appointment</h1>
                  ...
                  {showCalendar && (
                    ...
                    >
                      <calendar-date className="cally" onchange={handleDateChange}>
                        <svg aria-label="Previous" className="fill-current w-4 h-4" slot="previous" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                          <path d="M15.75 19.5 8.25 12l7.5-7.5"></path>
                        </svg>
                        <svg aria-label="Next" className="fill-current w-4 h-4" slot="next" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
