    ...
    <div className="pt-10 mx-auto p-5" style={{ backgroundColor: '#42614f' }}>
      ...
      <div className="container pt-10 mx-auto p-4">
          ...
          <div className="flex flex-col p-4 border border-gray-200 rounded-2xl ">
            ...
            <div>
              {announcementCard.map((announcementCard, index) => (
                <div key={announcementCard.$id} setAnnoCard={setAnnouncementCard} className={`mb-4 p-4 border-b border-gray-200`}>
                  <AnnounceCard key={announcementCard.$id} announcementData={announcementCard} />
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          {announcementCard.map((announcementCard) => (
            announcementCard.isDisplayed && (
              <div key={announcementCard.$id} className="mb-4 p-4 border-b border-gray-200">
