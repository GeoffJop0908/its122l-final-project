...
function Feedback() {
    ...
    return (
        ...
        <div className="text-center">
          ...
          <div className="text-lg text-white">Generate feedback to help us improve</div>
          <br className="mt-4" />
          <br className="mt-4" />
          <br className="mt-4" />
          <br className="mt-4" />
        ...
        <div className="container pt-10 mx-auto p-4">
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            {feedbackCard.map((feedbackCard) => ((
                <div key={feedbackCard.$id} className="mb-4 p-4 border-b border-gray-200 flex flex-row justify-between ">
                    <div>
                    {feedbackCard.feedbackTitle}
                    </div>
                    <div>
                    {feedbackCard.feedbackBody}
                    </div>
                    <div>
                    {feedbackCard.$createdAt}    
                    </div>
                </div>
            )))}
          </div>
