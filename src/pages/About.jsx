    ...
    <div className="flex flex-col items-center justify-center h-full pt-10">
      ...
      <div className="w-full flex flex-col items-center">
        ...
        <p className="text-lg text-black max-w-[60%] text-justify my-6 leading-relaxed">
          Greenhills Christian Fellowship (GCF) was founded on February 14, 1978
          by a missionary couple from America, Dave and PJ Yount. What started
          then as a Valentine’s Day event has now turned into a community of
          over 7,000 worshipers.
        </p>
        ...
        <p className="text-lg text-black max-w-[60%] text-justify my-6 leading-relaxed">
          ...
          eldership. We are a member of the Conservative Baptist Association of
          the Philippines (CBAP) and a partner of various Christian
