    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full pt-10">
        ...
        <div className="w-full flex flex-col items-center">
          <h1 className="text-5xl font-bold text-black mb-8">About The GCF</h1>

          <div className="bg-white/90 p-8 rounded-lg shadow-lg max-w-[70%]">
            ...
            >
              <button className="bg-jungle-green-600 text-white py-3 px-6 rounded-md mt-6 hover:bg-jungle-green-700 transition-colors">
                Learn More
              </button>
            </Link>
          </div>
